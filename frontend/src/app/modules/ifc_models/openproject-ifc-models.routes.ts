...
export const IFC_ROUTES:Ng2StateDeclaration[] = [
  ...
  {
    name: 'bim.partitioned.defaults.single_bcf',
    url: '/details/{workPackageId:[0-9]+}',
    redirectTo: 'bim.partitioned.defaults.single_bcf.overview',
    reloadOnSearch: false,
    data: {
      viewRoute: 'bim.partitioned.defaults',
      partition: '-split'
  ...
  {
    name: 'bim.partitioned.defaults.single_bcf.overview',
    url: '/overview',
    component: WorkPackageOverviewTabComponent,
    data: {
      parent: 'bim.partitioned.defaults.single_bcf'
    }
  },
  {
    name: 'bim.partitioned.defaults.single_bcf.activity',
    url: '/activity',
  ...
  {
    name: 'bim.partitioned.defaults.single_bcf.relations',
    url: '/relations',
  ...
  {
    name: 'bim.partitioned.defaults.single_bcf.watchers',
    url: '/watchers',
